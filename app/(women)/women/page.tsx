...
import { getGirlDress } from "@/queries/getGirlDress";
import { getWomenDress } from "@/queries/getWomenDresss";
import { getYoungGirl } from "@/queries/getYoungGirl";
import Image from "next/image";

const WomenPage = async () => {
  const youngGirl = await getYoungGirl();
  const girl = await getGirlDress();
  const women = await getWomenDress();
